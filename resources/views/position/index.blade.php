<x-app-layout>
    ...
    <div class="px-8 py-4 bg-white drop-shadow-xl flex justify-between">
        ...
        <a href="/position-create" class="rounded px-2 py-1 bg-red-400 text-white hover:bg-slate-700 hover:text-white">Add
            Position</a>
    </div>
    ...
    <div class="py-12">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="container my-8 px-8 bg-slate-100 flex flex-col gap-4">
                <h4 class="font-bold text-xl">List of Available Positions</h4>
                                ...
                                <tr>
                                    ...
                                    <td class="py-2 px-4 text-center border-b">
                                        <div class="flex items-center justify-center gap-2">
                                            <a href="/position/{{ $position->id }}/edit" class="btn btn-link p-0"
